...
//     // Get the first name from localStorage and extract first letter
//     const firstName = localStorage.getItem('first_name');
//     if (firstName && firstName.length > 0) {
//       setFirstLetter(firstName[0].toUpperCase());
//     }
...
//                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A9.003 9.003 0 0112 3a9.003 9.003 0 016.879 14.804M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
//                       </svg>
//                       Profile
//                     </Link>
